...
public class App {
  public static void main(String[] args) {
    ...
    final int SIZE = 3; // 변수값 변경 불가 final
    ...
    while (true) {
      ...
      if (menuNo == 0 ) {
       ...
       if (boardIndex == -1) {
        ...
        if (boardCount == SIZE) {
          System.out.println("게시글을 더이상 저장 할 수 없습니다.");
          continue;
        }
        ...
        no[boardCount] = boardCount == 0 ? 1 : no[boardCount - 1] + 1; // 삼항연산자
          ...
          System.out.println("1에서 3 사이의 메뉴 번호를 입력하세요:");
